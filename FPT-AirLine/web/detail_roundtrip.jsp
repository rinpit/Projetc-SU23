    ...
    <body>
                            ...
                            <c:forEach var="list" begin="1" end="${adult}"><!-- người lớn -->
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" style="padding: 15px; background: #ffffff";">
                                    <tr>      
                                        ...
                                        <td colspan="2">
                                            <p><input type="text" style="width: 270px" name="nameAdult<c:out value="${aNum}"/>" required></p>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="date" name="txtDateA<c:out value="${aNum}"/>" id="birthdateAdult" min="1900-01-01" style="margin-bottom: 10px"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="1">
                                        ...
                                        <td>
                                            <p><input name="cccd<c:out value="${aNum}"/>" maxlength="12" oninput="checkInputLength(event)" type="text" style="width: 270px;" required></p>
                                        </td>
                                    </tr>
                                </table>
                            </c:forEach>
        ...
        <script>
            function checkInputLength(event) {
                ...
                if (value.length > 12) {
                    alert("Vui lòng chỉ nhập tối đa 12 số!");
                    input.value = value.slice(0, 12); // Cắt bỏ các chữ số vượt quá giới hạn
                }
            }
        </script>
