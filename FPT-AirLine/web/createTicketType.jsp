        ...
        <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form action="createTicketTypeServlet" method="post">
                        <div class="container">
                            <div class="table">
                                <div class="table-header">
                                    ...
                                    <div class="header__item"><a id="draws" class="filter__link filter__link--number">Ngày bắt đầu</a></div>
                                    <div class="header__item"><a id="draws" class="filter__link filter__link--number">Ngày kết thúc</a></div>
                                </div>
                                <div class="table-content">	
                                    <div class="table-row">	
                                        <div class="table-data"><input type="text" placeholder="Tên" name="name"></div>
                                        <div class="table-data"><input type="text" placeholder="Giá" name="price"></div>
                                        <div class="table-data"><input type="date" placeholder="Ngày bắt đầu" name="startDay"></div>
                                        <div class="table-data"><input type="date" placeholder="Ngày kết thúc" name="endDay"></div>
                                    </div>
                                </div>
