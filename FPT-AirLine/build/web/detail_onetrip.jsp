                                ...
                                <c:forEach var="list" begin="1" end="${adult}"><!-- người lớn -->
                                    <table width="100%" cellpadding="0" cellspacing="0" style="padding: 15px; background: #ffffff";">
                                        <tr>      
                                            ...
                                            <td colspan="2">
                                                <p><input id="fullname" type="text" style="width: 270px" name="nameAdult${list}"></p>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="date" name="txtDate${list}" id="txtDate" min="1900-01-01" style="margin-bottom: 10px"/>
                                            </td>
                                        </tr>
                                    </table>
                                </c:forEach>
                                ...
                                <c:forEach var="list" begin="1" end="${kid}"><!-- trẻ em -->
                                    <table width="100%" cellpadding="0" cellspacing="0" style="padding-top: : 150px; ";">
                                        <tr>      
                                            ...
                                            <td colspan="2">
                                                <p><input id="fullname" type="text" style="width: 270px;"></p>
                                            </td>
