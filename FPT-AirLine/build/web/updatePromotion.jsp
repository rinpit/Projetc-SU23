...
<html>
    <head>
        ...
        <link rel="stylesheet" href="access/css/createPromotion.css"/>
    </head>
    <body>
        <div class="preloader">
        ...
        <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div id="container">
                        <h1>&bull; Cập nhật mã giảm giá &bull;</h1>
                        <div class="underline">
                        </div>
                        <form action="updatePromotionServlet" method="post">
                            <div class="startDay">
                                <label for="startDay">Ngày bắt đầu</label>
                                <input type="date" name="startDay" class="inputDay" value="${promotion.startDate}" required>
                            </div>
                            <div class="endDay">
                                <label for="startDay">Ngày kết thúc</label>
                                <input type="date" name="endDay" class="inputDay" value="${promotion.endDate}" required>
                            </div>
                            <div class="promotionID">
                                <label for="promotionID"></label>
                                <input type="text" placeholder="Mã code" name="promotionID" value="${promotion.id}" readonly>
                            </div>
                            <div class="price">
                                <label for="price"></label>
                                <input type="text" placeholder="Giá (VND)" name="price" value="${promotion.amount}" required>
                            </div>
                            <div class="description">
                                <label for="description">Mô tả</label>
                                <textarea name="description" placeholder="Mô tả" id="message_input" cols="30" rows="3" required>${promotion.description }</textarea>
                            </div>

                            <div class="submit">
                                <input type="submit" value="Cập nhật" id="form_button" />
                            </div>
                        </form>
                    </div>
                </div>
