...
<html>
    ...
    <body>
        ...
        <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <c:set var="listOrder" value="${filterOrderLish}"/>
                    <c:set var="maxPage" value="${cusList.getMaxPage(pageSize, listOrder.size())}"/>
                    <div class="row">
        ...
        <script>
            ...
            // Get the value of the "month" query parameter from the URL
            var urlParams = new URLSearchParams(window.location.search);
            var monthValue = urlParams.get('month');

            // Select the option corresponding to the month value
