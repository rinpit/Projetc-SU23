                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${listFlightOne}" var="p">
                                            <tr class="table-info">
                                                ...
                                                <td><input type="radio" name="flightId" value="${p.flightId}"><label></label>Chọn</td>
                                            </tr>
                                                        ...
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input class="price" type="text" name="ticketTypePrice"
                                                                               value="${listTicket.get(0).ticketPrice} VND"
                                                                               style="background-color: rgb(65, 225, 225); border-radius: 50px; width: 120px;"
                                                                               disabled>
                                                                    </td>
                                                                    <td>10%</td>
                                                                    <td><input class="totalAdult" type="text" name="ticketTotalA"
                                                            ...
                                                            <tbody>
                                                                <c:if test="${kid > 0}">
                                                                    <tr>
                                                                        ...
                                                                        <td>10%</td>
                                                                        <td>
                                                                            <input class="totalKid" type="text" name="ticketTotalK"
