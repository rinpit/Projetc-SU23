...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./access/css/payment.css"/>
    </head>
    <body>
        <div class="container">
                ...
                <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <a href="OrderTicketServlet" class="btn btn-info" role="button">Thanh toán trực tiếp</a>
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div id="collapseTwo" class="collapse" data-parent="#accordion">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <a href="OrderTicketServlet" class="btn btn-info" role="button">Chọn</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-2">
